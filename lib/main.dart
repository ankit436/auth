...
const String AUTH0_CLIENT_ID = 'ux4KV44HV66LhO3BzssmpXmSSbPpFlm1';
...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> loginAction() async {
    ...
    try {
      ...
      final Map<String, Object> idToken =
          parseIdToken(result!.idToken.toString());
  ...
  Future<void> initAction() async {
    ...
    try {
      ...
      final Map<String, Object> idToken =
          parseIdToken(response!.idToken.toString());
      final Map<String, Object> profile =
          await getUserDetails(response.accessToken.toString());
